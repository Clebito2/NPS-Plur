...
import { SurveyData, SurveyField } from './types';
...
const App: React.FC = () => {
  ...
  // --- ACTIONS ---
  const updateData = (field: SurveyField, value: any) => {
  ...
  const handleNext = () => {
    ...
    if (currentStep === 2 && !formData.professor) return;
  ...
  const isStep2Valid = !!formData.professor; // Only professor is strictly required by prompt
    ...
    <div className="min-h-screen relative font-sans text-white pb-20">
      ...
      <main className="max-w-2xl mx-auto px-4 relative z-10">
        ...
        <div className="transition-all duration-300 ease-in-out">
          ...
          {currentStep === 2 && <Step2Method data={formData} updateData={updateData} />}
